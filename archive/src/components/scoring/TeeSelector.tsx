    ...
    <div className="space-y-3">
      <div>
        <label className="block text-sm font-medium text-gray-700">
          Which tees will you play from?
        </label>
        <p className="text-xs text-gray-500 mt-1">
          This will be the default for other players too, but they can choose different tees.
        </p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-5 h-5 rounded-full ${colorClass} flex-shrink-0`} />
                <span className="font-medium text-gray-900 flex-1">{tee.tee_name}</span>
                {isSelected && (
              ...
              <div className="grid grid-cols-4 gap-2 mt-3">
                <div className="bg-gray-50 rounded-lg px-2 py-1.5 text-center">
                  <div className="text-[10px] font-medium text-gray-500 uppercase tracking-wide">Yards</div>
                  <div className="text-sm font-semibold text-gray-900">{tee.total_yards?.toLocaleString() || "—"}</div>
                </div>
                <div className="bg-gray-50 rounded-lg px-2 py-1.5 text-center">
                  <div className="text-[10px] font-medium text-gray-500 uppercase tracking-wide">Rating</div>
                  <div className="text-sm font-semibold text-gray-900">{tee.course_rating}</div>
                </div>
                <div className="bg-gray-50 rounded-lg px-2 py-1.5 text-center">
                  <div className="text-[10px] font-medium text-gray-500 uppercase tracking-wide">Slope</div>
                  <div className="text-sm font-semibold text-gray-900">{tee.slope_rating}</div>
                </div>
                <div className="bg-gray-50 rounded-lg px-2 py-1.5 text-center">
                  <div className="text-[10px] font-medium text-gray-500 uppercase tracking-wide">Par</div>
                  <div className="text-sm font-semibold text-gray-900">{tee.par}</div>
                </div>
              </div>
            </button>
          );
