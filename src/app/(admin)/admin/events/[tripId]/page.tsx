...
import { ScrambleStatsManager } from "@/components/admin/ScrambleStatsManager";
...
export default function EventDetailPage() {
  ...
  return (
    <div className="px-4 pt-6 pb-8 space-y-3">
      ...
      {can("manage_loozer_metrics") && (
        <CollapsibleSection
          title="Loozer Metrics"
          summary="8 Bag Avg & Avg Scramble Score"
          icon={
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        >
          <ScrambleStatsManager tripId={tripId} />
        </CollapsibleSection>
      )}
      ...
      {can("manage_finances") && (
        <Link
          href={`/admin/events/${tripId}/financials`}
          className="flex items-center gap-3 bg-white rounded-2xl border border-gray-200 shadow-sm px-4 py-4 active:bg-gray-50 transition-colors"
        >
          <div className="flex items-center justify-center w-10 h-10 rounded-full bg-emerald-50 text-emerald-700 flex-shrink-0">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500">Balances, payments &amp; ledger</p>
          </div>
          <svg className="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          </svg>
