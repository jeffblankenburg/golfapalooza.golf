...
function notificationIcon(type: string) {
  switch (type) {
    ...
    case "favorite_round_started":
    case "favorite_hole_completed":
    case "favorite_round_completed":
      return (
      ...
      return (
        <div className="w-8 h-8 rounded-full bg-sky-100 flex items-center justify-center flex-shrink-0">
          <svg className="w-4 h-4 text-sky-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m0 0h2a2 2 0 012 2v9a2 2 0 01-2 2h-2m0-13v13M9 8h4m-4 4h4m-4 4h2" />
          </svg>
        </div>
      );
    default:
...
function getNotificationLink(notification: Notification): string | null {
  ...
  // Favorite + round-comment notifications (issue #140) carry their own deep
  // link in data.url — route to the read-only spectator scorecard.
