...
export function MappedStatusBadge({
  ...
  if (totalHoles === 0) {
    return (
      <span className="inline-flex items-center px-2 py-0.5 text-[0.625rem] font-medium bg-gray-100 text-gray-500 rounded-md">
        Not mapped
      </span>
    );
  }
  if (fullyMappedHoles === totalHoles) {
    return (
      <span className="inline-flex items-center gap-1 px-2 py-0.5 text-[0.625rem] font-semibold bg-green-50 text-green-700 rounded-md">
  ...
  if (variant === "verbose" && setPoints != null && totalPoints != null) {
    return (
      <span className="inline-flex items-center px-2 py-0.5 text-[0.625rem] font-medium bg-amber-50 text-amber-700 rounded-md">
